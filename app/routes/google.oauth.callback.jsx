...
export const loader = async ({ request }) => {
  ...
  if (err) return page("Google connection cancelled", `Google returned: ${err}. You can close this tab and try again.`);
  ...
  try {
    ...
    return page("Couldn't connect", `Google rejected the token exchange: ${e?.message || "unknown error"}. Check the OAuth client + redirect URI, then try again.`);
  }
};
